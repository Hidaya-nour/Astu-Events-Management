      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <Badge className="bg-primary-600 text-white hover:bg-primary-700">Help Center</Badge>
          ...
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-3xl space-y-8">
              <Accordion type="single" collapsible className="w-full">
                {faqs.map((faq, index) => (
                  <AccordionItem key={index} value={`item-${index}`} className="border border-gray-200 mb-4 rounded-lg">
                    <AccordionTrigger className="text-left text-lg font-medium text-primary-800 px-6">
                      {faq.question}
                    </AccordionTrigger>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-primary-50">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <Badge className="bg-primary-100 text-primary-800 hover:bg-primary-200">Browse by Topic</Badge>
                <h2 className="text-3xl font-bold tracking-tighter text-primary-800 sm:text-4xl">FAQ Categories</h2>
                <p className="max-w-[900px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              {categories.map((category, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center space-y-2 rounded-lg border border-gray-200 p-6 text-center shadow-sm bg-white hover:shadow-md hover:border-primary-300 transition-all"
                >
                  ...
                  <Link href={category.link} className="text-sm font-medium text-primary-600 hover:text-primary-800">
                    View FAQs
                  </Link>
                </div>
              ))}
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-white border-t border-gray-200">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              <Badge className="bg-primary-100 text-primary-800 hover:bg-primary-200 mx-auto">Need More Help?</Badge>
              <h2 className="text-3xl font-bold tracking-tighter text-primary-800 md:text-4xl/tight">
            ...
            <div className="mx-auto flex flex-col gap-2 min-[400px]:flex-row justify-center">
              ...
              <Link href="/events">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-primary-600 text-primary-600 hover:bg-primary-50 px-8"
                >
                  Browse Events
                </Button>
              </Link>
