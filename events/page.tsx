  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-primary-50/30">
      <div className="container py-12 md:py-16">
        ...
        >
          <Badge className="mb-4 bg-primary-600 text-white">Events Calendar</Badge>
          <h1 className="mb-4 text-4xl font-bold tracking-tight text-primary-800 md:text-5xl">
          ...
          <div className="flex w-full items-center space-x-2 md:w-auto">
            <div className="relative w-full md:w-80">
              ...
              <Input
                ...
                className="w-full bg-white pl-8 md:w-80 border-gray-200 focus:border-primary-500 transition-all duration-300"
                value={searchQuery}
        ...
        {(searchQuery || selectedCategories.length > 0) && (
          ...
          >
            ...
            {selectedCategories.map((category) => (
              <Badge key={category} variant="outline" className="flex items-center gap-1 bg-white">
                {category}
        ...
        {isLoading ? (
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              ...
              >
                ...
                <div className="mt-1 h-4 w-2/3 animate-pulse rounded bg-gray-200"></div>
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-300 bg-white p-12 text-center"
          >
            ...
            <Button onClick={clearFilters} className="mt-4 bg-primary-600 hover:bg-primary-700 text-white">
              Clear filters
            </Button>
          </motion.div>
        ) : (
          ...
          >
            <AnimatePresence>
              {filteredEvents.map((event, index) => (
                ...
                >
                  <Card className="overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl group h-full flex flex-col">
        ...
        {!isLoading && filteredEvents.length > 0 && (
          ...
          >
            ...
            <Button variant="outline" size="sm" className="h-8 w-8 p-0 bg-primary-50">
              1
            </Button>
